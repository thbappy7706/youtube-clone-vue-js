...
<template>
    <div @mouseover="show = true" @mouseleave="show = false">
        <img width="340"
            ...
            :src="vid.thumbnail || ''" :class="show ? 'delay-350 hidden' : '' "
...
<div class="w-[500px]">
    <div class="px-1.5 pl-3 text-white mt-1">
        ...
        <p class="text-[12px] text-gray-300 font-extrabold flex gap-1 items-center cursor-pointer">{{ vid.user }} <CheckCircle fillColor="#888888" :size="17"/></p>
