    ...
    <div class="relative">
        <div id="TopNav" class="w-[100%] h-[60px] fixed bg-black z-20 flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="mx-2"></div>
                <div class="flex items-center justify-center mr-10 cursor-pointer text-white">
                    YOUTUBE
                </div>
            </div>
            ...
            <div>
                <img class="rounded-full mx-8" width="35"
                     src="https://yt3.ggpht.com/oI_aTk2o34uCpzhj6vojAHlTrfGEu7ptFsIegGvvPJBR_Wm2Tr6tE2mxd4Z_53tgw9zsbZITqW8=s88-c-k-c0x00ffffff-no-rj-mo">
            </div>
        </div>

        <div id="SideNav" class="h-[100%] fixed z-0 bg-black" :class="[!openSideNav ? 'w-[70px]': 'w-[240px]']">
